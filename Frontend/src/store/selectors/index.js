...
export const authWallet = (state) => state.auth.wallet;
...
export const newHotCollectionsState = (state) => state.hotCollection.newHotCollections;
export const userHotCollectionsState = (state) => state.hotCollection.userHotCollections;
export const oneCollectionState = (state) => state.hotCollection.oneCollection;
...
export const authorDetail = (state) => state.authors.authorDetail;
