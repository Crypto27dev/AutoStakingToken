  ...
  saveItem = (params) => {
    ...
    axios({
      ...
      .then(async function (response) {
        if (params.isSale > 0) {
          var aucperiod = (params.isSale === 1 ? 0 : response.data.auctionPeriod) ;
          var price = (params.isSale === 1  ? response.data.price :  response.data.auctionPrice)
                ...
                <div className="field-set">
                  ...
                  <div className="d-create-file">
                    ...
                    {this.state.selectFile && (
                      <p>{this.state.selectFile.name}</p>
                    )}
